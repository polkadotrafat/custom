...
impl pallet_xcmdemo::Config for Runtime {
	type Call = Call;
	type Event = Event;
	type Origin = Origin;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		OcwPallet: pallet_ocw::{Pallet, Call, Storage, Event<T>}  = 41,
		XcmdemoPallet: pallet_xcmdemo::{Pallet, Call, Storage, Event<T>}  = 42,

		//Moonbeam
		//EVM: pallet_evm::{Pallet, Call, Storage, Config, Event<T>} = 50,
		//Ethereum: pallet_ethereum::{Pallet, Call, Storage, Event, Origin} = 51,
	}
);
